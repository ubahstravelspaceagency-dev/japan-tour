exports.handler = async function (event) {
  ...
  // Wraps fetch with a hard timeout so a slow/hanging third-party call
  // can never stall the whole function indefinitely.
  ...
  try {
    ...
    // Update Supabase with the payment details. Has its own timeout so a
    // slow/hanging Supabase call can't stall the response to the browser.
